<div class="row containerGralJuegos">
  ...
  <div class="row col-12 col-lg-9 contenedorJuegos">
    <div class="contenedorImg col-6 col-lg-4 contPortadasIndex">
        <img class="juegosIndex" src="images/MetroExodus.jpg" alt="">
        <p id=nombreJuego>Metro Exodus</p>
        <p id="JuegosCat">Juegos Xbox One</p>
        <div class="row precioCarro">
            <div class="col-6 precioIndex">
    ...
    <div class="contenedorImg col-6 col-lg-4 contPortadasIndex">
        <img class=juegosIndex src="images/Soulcalibur6.jpg" alt="">
    ...
    <div class="contenedorImg col-6 col-lg-4 contPortadasIndex">
        <img class=juegosIndex src="images/spiderManIcon.jpg" alt="">
    ...
    <div class="contenedorImg col-6 col-lg-4 contPortadasIndex">
        <img class="juegosIndex" src="images/fallout76.jpg" alt="">
    ...
    <div class="contenedorImg col-6 col-lg-4 contPortadasIndex">
        <img class=juegosIndex src="images/pes19.jpg" alt="">
    ...
    <div class="contenedorImg col-6 col-lg-4 contPortadasIndex">
        <img class=juegosIndex src="images/redDeadRedemptionIcon.jpeg" alt="">
